...
function initMessageBox(bNeebBack) {
    ...
    objString += "<div style='text-align:center; width:380px; background-color:#FFFFFF;display:block'>";
    objString += "<br/>Preview Mode: ";
    objString += "<select size='1' id='DW_PreviewMode' onchange ='setlPreviewMode();'>";
    objString += "    <option value='0'>1X1</option>";
    objString += "</select><br/><br/>";
    objString += "<div><input id='DW_btnRemoveCurrentImage' onclick='btnRemoveCurrentImage_onclick()' type='button' value='Remove Selected Image'/>";
    ...
    objString += "<div id='DWTdivMsg' style='width:380px;display:inline'>";
    objString += "Message:<br />"
    objString += "<div id='DWTemessage' style='width:380px;height:80px; overflow:scroll; background-color:#ffffff; border:1px #303030; border-style:solid; text-align:left; position:relative' >";
    objString += "</div></div>";
